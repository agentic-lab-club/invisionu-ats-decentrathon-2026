...
export default function CandidatePage() {
  ...
  const fetchInterviewSession = async () => {
    ...
    try {
      ...
      // 404 = no session yet, 400 = route param issue (backend not rebuilt yet)
      // Both cases: treat as "no session found", not an error
      ...
      // Normalise JSONB arrays that might come back as strings
      setInterviewSession({
        ...session,
      ...
      console.error('fetchInterviewSession:', e);
